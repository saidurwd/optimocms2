...
<html lang="<?= Yii::$app->language ?>">	
    ...
    <body class="">
        ...
        <header id="header">
            ...
            <div class="pull-right">
                ...
                <div id="logout" class="btn-header transparent pull-right">
                    <span>
                        <?= Html::a('<i class="fa fa-sign-out"></i>', ['/site/logout'], ['data-method' => 'post', 'title' => 'Sign Out', 'data-action' => 'userLogout', 'data-logout-msg' => 'You can improve your security further after logging out by closing this opened browser']) ?>
                    </span>
                </div>
                <!-- end logout button -->
        ...
        <aside id="left-panel">
            ...
            <div class="login-info">
                <span> <!-- User image size is adjusted inside CSS, it should stay as is --> 
                    <a href="javascript:void(0);" id="show-shortcut" data-action="toggleShortcut">
                        <?php //echo User::get_profile_picture(Yii::$app->user->identity->id); ?>
                        <span>
                            <?php echo \common\models\User::get_full_name(Yii::$app->user->identity->id); ?>
                        </span>
            ...
            -->
            <nav>
                <?php backend\models\Menu::get_menu(); ?>
            </nav>
        ...
        <div class="page-footer">
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <span class="txt-color-white">Copyright &copy; <?= date('Y'); ?>. <?= Yii::powered() ?></span>
                </div>
